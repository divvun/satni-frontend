...
export type Query = {
  ...
  korpLemmaExists?: Maybe<Scalars['Boolean']['output']>;
...
export type QueryKorpLemmaExistsArgs = {
  language: Scalars['String']['input'];
...
export type KorpLemmaExistsQueryVariables = Exact<{
  language: Scalars['String']['input'];
  lemma: Scalars['String']['input'];
}>;


export type KorpLemmaExistsQuery = { __typename?: 'Query', korpLemmaExists?: boolean | null };
