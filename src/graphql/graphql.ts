/* eslint-disable */
import type * as core from "@graphql-typed-document-node/core";
...
export class TypedDocumentString<TResult, TVariables>
  extends String
  implements core.DocumentTypeDecoration<TResult, TVariables>
{
  __apiType?: NonNullable<
    core.DocumentTypeDecoration<TResult, TVariables>["__apiType"]
  >;
  ...
  override toString(): string & core.DocumentTypeDecoration<TResult, TVariables> {
    return this.value;
  }
}
